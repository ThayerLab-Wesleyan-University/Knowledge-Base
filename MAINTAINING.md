...
The source archive and record directories must agree. Restore missing records from Git rather than treating a partial collection as new. Do not edit hashes to hide changed source bytes. Document removal, version merging, human review queues, and bulk re-inference remain outside v0.1.
